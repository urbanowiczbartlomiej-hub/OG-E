 ...
 *   attackAlarm             false — loud full-screen alert while under attack (opt-in)
...
export const SETTINGS_SCHEMA = {
  ...
  attackAlarm:            { type: 'bool',   default: false, key: SETTINGS_PREFIX + 'attackAlarm' },
