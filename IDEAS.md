...
See related: idea #7 (watchlist sync — the C6 silent-wipe class applies here
too) and `SPYGLASS-SYNC-PLAN.md` (local watchlist/relations sync, the
single-user precursor). Decided 2026-07-09: backlog only, own design session
before any code.
