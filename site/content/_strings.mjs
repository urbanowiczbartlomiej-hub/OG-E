...
export const STRINGS = {
  pl: {
    ...
    hero: {
      ...
      lead:
        'OG-E to **wyłącznie nakładka na interfejs** — nie automatyzuje gry, nie jest botem, nie monitoruje Twojej floty, nie powiadomi Cię, kiedy jesteś atakowany, nie klika za Ciebie i nie podtrzymuje Twojej aktywności.',
      chips: [
        'Nakładka na UI',
        'Nie bot',
        'Zero własnych żądań',
      ...
      meta:
        'Poniżej każda funkcja opisana jedna pod drugą: co robi, jak działa, jaką buduje przewagę i dlaczego jest fair.',
    },
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'OGame Expeditions',
      lead:
        "OG-E is **purely a UI overlay** — it doesn't automate the game, it isn't a bot, it doesn't monitor your fleet, it won't notify you when you're under attack, it doesn't click for you and it never keeps your account looking active.",
      ...
      meta:
        'Below, every feature is described one after another: what it does, how it works, what edge it builds and why it plays fair.',
    },
