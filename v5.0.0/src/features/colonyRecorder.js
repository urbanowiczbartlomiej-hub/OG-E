...
//
// This was painfully re-discovered in v4 4.8.3 and is documented at
// length in `src/state/history.js`: the histogram is meant to estimate
...
//
// The v5 content script runs the install once on boot. OGame reloads the
...
// @see ../../../content.js — v4 `collectColonyData()` is the behavioural
//   reference this module rewrites against.
