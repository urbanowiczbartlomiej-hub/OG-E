...
// the next visible action panel — mirrors v4 `mobile.js:400`.
//
...
// (TOS clean per DESIGN.md §3 — no automated chains).
//
// Pre-conditions:
...
//     move the caret then.
//   - Target element has `offsetParent !== null` (i.e. visible). v4
//     uses the same check; jQuery UI dialogs sometimes leave the
//     buttons present but `display:none`, and clicking a hidden
//     button no-ops with a confusing UX.
//
