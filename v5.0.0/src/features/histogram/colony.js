...
// @see ../../../../histogram.js:128  — v4 reference implementation
...
// Bar-height constants — lifted verbatim from v4. The chart container
// is 300px tall; we reserve ~55px for the top count label and bottom
...
export const renderColonyChart = (opts) => {
  ...
  // Stat cards in the canonical order — matches the v4 layout so users
  // who scan the row by position (not label) see the same numbers in
  // the same slots.
