...
//
// Behavioural tests for the rewritten colonize button (see
// `src/features/sendCol.js` + `SENDCOL_DESIGN.md`).
//
// # Test coverage strategy
//
// The new module factors into three layers — we test each directly:
//
...
const setFleetDispatcher = (snap) => {
  ...
  document.dispatchEvent(
    new CustomEvent('oge5:fleetDispatcher', { detail: snap }),
  );
};
...
describe('onScanClick', () => {
  ...
  it('cooldown: second click ignored until oge5:galaxyScanned arrives', () => {
...
describe('oge5:checkTargetResult reactor', () => {
...
describe('oge5:colonizeSent reactor', () => {
  it('marks the sent slot empty_sent in scansStore + NO auto-redirect', () => {
    ...
    installSendCol();
    document.dispatchEvent(
      new CustomEvent('oge5:colonizeSent', {
  ...
  it('bad detail payload is tolerated (no-op)', () => {
    ...
    document.dispatchEvent(
      new CustomEvent('oge5:colonizeSent', { detail: { galaxy: 'oops' } }),
    );
