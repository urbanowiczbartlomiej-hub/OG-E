...
describe('STATUS_PRIORITY', () => {
  it('lists every PositionStatus exactly once', () => {
    // 11-status enum from src/domain/scans.js (`reserved` =
    // slot reserved for planet-move).
    const expected = [
...
describe('collectGalaxyStats', () => {
   ...
   * (anything not in the PositionStatus enum) without per-test casts.
   *
